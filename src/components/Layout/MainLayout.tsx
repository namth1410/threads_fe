...
import { HomeOutlined, UserOutlined, BellOutlined, MessageOutlined, LogoutOutlined } from '@ant-design/icons';
    ...
    <Layout style={{ minHeight: '100vh' }}>
      <Header>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
          <Link to="/" style={{ fontSize: '24px', fontWeight: 'bold', color: '#000', textDecoration: 'none' }}>
            {t('app.name')}
          </Link>
